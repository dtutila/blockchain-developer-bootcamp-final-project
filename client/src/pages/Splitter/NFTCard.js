  ...
  return (
    <Container show>
      <Card style={{ maxWidth: 420, minHeight: 400 }}>
        ...
        <FieldInput balance={ethBalance} value={depositAmount} setValue={setDepositAmount} currency="eth" title="NFT Address"/>

        <FieldInput balance={cTokenBalance} value={convertedAmount} currency="cToken" title="Token Id" />
        <Button primary disabled={depositAmount <= 0} className="mt-3" onClick={handleDepositSubmit}>
         Create
        </Button>
      </Card>
    </Container>
